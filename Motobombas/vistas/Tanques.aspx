...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="auto-style12">
        <tr>
            <td class="auto-style23" colspan="2">Tanques</td>
        </tr>
        <tr>
            <td>
                <asp:GridView ID="GridView1" runat="server" align="Center" AutoGenerateColumns="False" BackColor="White" BorderColor="#336666" BorderStyle="Double" BorderWidth="3px" CellPadding="4" DataSourceID="Tanques" GridLines="Horizontal" AllowPaging="True">
                    <Columns>
